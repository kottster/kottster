...
Open `app/.server/app.js` file and update it to use separate keys based on the environment, like this:
...
You can change the port by setting the `PORT` environment variable. By default, it will run on port `5480`.
...
Alternatively, you can run your app in a Docker container. Learn more about how to run your Kottster app using Docker on the [Quickstart with Docker](/quickstart-docker) page.
...
<table style={{ width: '100%', tableLayout: 'fixed' }}>
  ...
  <tbody>
    <tr>
      <td><a href="https://digitalocean.com" rel="nofollow" target="_blank">DigitalOcean</a></td>
      <td><a href="https://www.digitalocean.com/community/tutorials/deploy-apps-with-custom-domain#what-is-digitalocean-app-platform" rel="nofollow" target="_blank">Build and Deploy Apps on DigitalOcean App Platform</a></td>
    </tr>
    <tr>
      <td><a href="https://vercel.com" rel="nofollow" target="_blank">Vercel</a></td>
      <td><a href="https://vercel.com/guides/deploying-remix-with-vercel" rel="nofollow" target="_blank">How to Deploy a Remix Site with Vercel</a></td>
    </tr>
    <tr>
      <td><a href="https://render.com" rel="nofollow" target="_blank">Render</a></td>
      <td>-</td>
    </tr>
    <tr>
      <td><a href="https://railway.app" rel="nofollow" target="_blank">Railway</a></td>
      <td><a href="https://docs.railway.com/guides/remix#deploy-the-remix-app-to-railway" rel="nofollow" target="_blank">Deploy a Remix App</a></td>
    </tr>
    <tr>
      <td><a href="https://fly.io" rel="nofollow" target="_blank">Fly.io</a></td>
      <td><a href="https://fly.io/docs/js/frameworks/remix/#deploy-a-remix-app" rel="nofollow" target="_blank">Run a Remix App</a></td>
    </tr>
    <tr>
      <td><a href="https://netlify.com" rel="nofollow" target="_blank">Netlify</a></td>
      <td><a href="https://docs.netlify.com/frameworks/remix/#manual-configuration" rel="nofollow" target="_blank">Remix on Netlify</a></td>
    </tr>
    <tr>
      <td><a href="https://heroku.com" rel="nofollow" target="_blank">Heroku</a></td>
      <td><a href="https://devcenter.heroku.com/articles/deploying-nodejs" rel="nofollow" target="_blank">Deploying Node.js Apps on Heroku</a></td>
    </tr>
    <tr>
      <td><a href="https://cloud.google.com/run" rel="nofollow" target="_blank">Google Cloud Run</a></td>
      <td>-</td>
    </tr>
    <tr>
      <td><a href="https://aws.amazon.com" rel="nofollow" target="_blank">AWS</a></td>
      <td>-</td>
    </tr>
    <tr>
      <td><a href="https://azure.microsoft.com" rel="nofollow" target="_blank">Azure App Service</a></td>
      <td>-</td>
    </tr>
  </tbody>
</table>
