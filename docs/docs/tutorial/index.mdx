...
The process takes up to 5 seconds. Once completed, the newly generated page will be available in the `./app/routes` folder.
...
Click the “**Add page**” button, enter the page name, select the "**Custom page**" or "**Empty page**" options, and click the “**Create**” button. This will create a new page in the `./app/routes` folder.
...
You can find examples of custom pages in our [live demo app](https://demo.kottster.app/):
- **[Analytics Dashboard](https://demo.kottster.app/analyticsDashboard)** | [Source code](https://github.com/kottster/live-demo/blob/main/app/routes/analyticsDashboard/index.jsx)
